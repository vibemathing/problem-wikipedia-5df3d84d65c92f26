...
```json
{
  ...
  "problem_contract": {
    ...
    "aliases": [
      "wikipedia:wikipedia-5df3d84d65c92f26"
    ],
    "allowed_axioms": [
    ...
    "domain": {
      "description": "Draft source observation in Number theory, Algebraic number theory; domain extraction is unresolved.",
      "objects": [
    ...
    "problem_id": "problem:wikipedia-5df3d84d65c92f26",
    "quantifiers": [
      {
    ...
    "sources": [
      {
        ...
        "source_record_id": "wikipedia-5df3d84d65c92f26",
        "url": "https://en.wikipedia.org/wiki/Algebraic_number_field#Bases_for_number_fields"
      }
    ],
    "statement": {
      "language": "en",
      "text": "Characterize all algebraic number fields that have some power basis .",
      "version": 1
    },
    "title": "Characterize all algebraic number fields that have some power basis .",
    "updated_at": "2026-09-15T21:28:00.195364Z"
  },
  "problem_contract_sha256": "88a95b60edf267ab95c65b05fe78abc0fb5bb3bf15b0a0f5ce4446a869ec5a47"
}
```
